...
class ChatAgent(BaseAgent):
    def analyze_chat_intent(self, user_msg: str) -> dict:
        ...
        - ⚠️ 絕對鐵律：只要使用者的輸入包含「任何一家咖啡廳的名字、連鎖店名（例如：星巴克、路易莎、北風社、響板、dine in cafe、alwqys day on 等）」或是「看起來像在指定某家店」，無論字數多短，都必須強制判定為 Search Mode！絕對不可當作閒聊！
        ...
        - ⚠️ 注意：只有在使用者真的是在問候、抱怨天氣、或說一些完全跟「找店」無關的話時，才使用此模式。
